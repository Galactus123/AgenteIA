        ...
        <div className="space-y-2.5 sm:space-y-3">
          {requests.map((req) => (
            ...
            >
              ...
              {req.reason && (
                <p className="text-xs mt-1.5 line-clamp-2" style={{ color: "var(--text-faint)" }}>{req.reason}</p>
              )}
              <div className="flex gap-2 mt-2.5">
                ...
                <button
                  className="flex-1 text-xs font-medium px-3 py-2.5 rounded-lg transition-colors min-h-[44px]"
                  style={{
