...
export default function AuthPage() {
  ...
  if (isMobile) {
    return (
      <div
        className={`relative flex flex-col overflow-hidden bg-gradient-to-br dark:from-[#0B0D14] dark:via-[#0D1020] dark:to-[#0F1328] from-slate-50 via-blue-50/30 to-indigo-50/20 ${inter.variable}`}
        style={{
      ...
      >
        ...
        <div className="relative z-10 flex flex-1 flex-col">
          ...
          {/* ── Tab switcher ─────────────────────────────────────────── */}
          <div
            className="flex rounded-2xl dark:bg-[#161926]/80 bg-white/80 backdrop-blur-md border border-[rgba(99,102,241,0.15)] shadow-sm p-1 mb-6"
            role="tablist"
          >
            <button
              role="tab"
          ...
          <div
            className="flex-1 rounded-3xl dark:bg-[#161926]/80 bg-white backdrop-blur-xl shadow-2xl dark:shadow-black/30 shadow-slate-200/50 border border-[rgba(99,102,241,0.15)] p-6"
          ...
          >
            ...
            {!isSignup && (
              ...
              >
                <h2 className="text-xl font-semibold dark:text-white text-slate-900 mb-1">Bem-vindo de volta</h2>
                <p className="text-sm dark:text-slate-400 text-slate-500 mb-6">Entre na sua conta para continuar.</p>
                ...
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  {loginError && (
                    <p className="text-sm text-red-500 dark:bg-red-500/10 bg-red-50 rounded-lg px-3 py-2">{loginError}</p>
                  )}
            ...
            {isSignup && !signupSuccess && (
              ...
              >
                <h2 className="text-xl font-semibold dark:text-white text-slate-900 mb-1">Criar conta</h2>
                <p className="text-sm dark:text-slate-400 text-slate-500 mb-6">Preencha os dados para começar.</p>
                ...
                <form onSubmit={handleSignUp} className="space-y-3">
                  ...
                  {signupError && (
                    <p className="text-sm text-red-500 dark:bg-red-500/10 bg-red-50 rounded-lg px-3 py-2">{signupError}</p>
                  )}
            ...
            {isSignup && signupSuccess && (
              <div className="text-center py-8">
                ...
                <h3 className="text-xl font-semibold dark:text-white text-slate-900">Conta criada!</h3>
                <p className="text-sm dark:text-slate-400 text-slate-500 mt-2 mb-6">Agora faça login para acessar o painel.</p>
                <button
                  onClick={() => {
  ...
  return (
    <div
      className={`relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br dark:from-[#0B0D14] dark:via-[#0D1020] dark:to-[#0F1328] from-slate-50 via-blue-50/30 to-indigo-50/20 ${inter.variable}`}
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl mx-4">
        <div
          className="relative flex min-h-[540px] rounded-3xl dark:bg-[#161926]/80 bg-white backdrop-blur-xl shadow-2xl dark:shadow-black/30 shadow-slate-200/50 border border-[rgba(99,102,241,0.15)]"
